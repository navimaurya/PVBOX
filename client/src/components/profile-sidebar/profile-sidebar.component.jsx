                            ...
                            <div className="card card-body card-bg-5">
                                ...
                                <div className="d-flex flex-column align-items-center">
                                    <div className="avatar avatar-lg mb-3">
                                        <img className="avatar-img" src="/assets/media/avatar/b8526894__3.png" alt="" />
                                    </div>
                                    ...
                                    <div className="d-flex">
                                        <button className="btn btn-outline-default mx-1" type="button">
                                            ...
                                            {/* <!-- <img className="injectable hw-18 d-sm-inline-block" src=".//assets/media/heroicons/outline/logout.svg" alt=""> --> */}
                                            <span>Logout</span>
                                        </button>
                                        <button className="btn btn-outline-default mx-1 d-xl-none" data-profile-edit="" type="button">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable hw-18 d-sm-inline-block" src=".//assets/media/heroicons/outline/cog.svg" alt=""> --> */}
                                            <span>Settings</span>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/heroicons/outline/clock.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/heroicons/outline/calendar.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/heroicons/outline/phone.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/heroicons/outline/mail.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/heroicons/outline/globe.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item pt-2">
                                        <div className="media align-items-center">
                                            <div className="media-body">
                                                ...
                                                <p className="mb-0">1134 Ridder Park Road, San Fransisco, CA
                                                    94851</p>
                                            </div>
                                            {/* <!-- Default :: Inline SVG --> */}
                                            <svg className="text-muted hw-20 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/heroicons/outline/home.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Default :: Inline SVG --> */}
                                            <svg className="text-muted hw-20 ml-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z">
                                                </path>
                                            </svg>

                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/icons/facebook.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/icons/twitter.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/icons/instagram.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
                                    ...
                                    <li className="list-group-item py-2">
                                        <div className="media align-items-center">
                                            ...
                                            {/* <!-- Alternate :: External File link --> */}
                                            {/* <!-- <img className="injectable text-muted hw-20 ml-1" src=".//assets/media/icons/linkedin.svg" alt=""> --> */}
                                        </div>
                                    </li>
                                    {/* <!-- List Group Item End --> */}
