        ...
        <div className="navigation navbar navbar-light bg-primary">
                ...
                <svg height="30" width="30" viewBox="0 0 512 511">
                    <g>
                        <path
                            ...
                            data-original="#000000" className="active-path" data-old_color="#000000" fill="#665dfe"></path>
                    </g>
                </svg>
            </Link>
            {/* <!-- Logo End --> */}
            ...
            <ul className="nav nav-minimal flex-row flex-grow-1 justify-content-between flex-xl-column justify-content-xl-center"
                ...
                <li className="nav-item">
                    <Link className="nav-link p-0 py-xl-3" to="/" title="Chats">
                        {/* <Link className="nav-link p-0 py-xl-3" to="/chats" title="Chats"> */}
                        {/* <!-- Default :: Inline SVG --> */}
                        ...
                        {/* <!-- <img className="injectable hw-24" src=".//assets/media/heroicons/outline/chat-alt-2.svg" alt="Chat icon"> --> */}
                    </Link>
                </li>
                {/* <!-- Chats Tab End --> */}
                ...
                {/* <BrowserView>
                    <li className="nav-item">
                        <Link className="nav-link p-0 py-xl-3 " id="calls-tab" to="/calls" title="Calls">
                            <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                ...
                {/* <!-- Friends Tab Start --> */}
                <li className="nav-item">
                    <Link className="nav-link p-0 py-xl-3" id="friends-tab" to="/friends" title="Friends">
                        {/* <!-- Default :: Inline SVG --> */}
                        <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                        ...
                        {/* <!-- Alternate :: External File link --> */}
                        {/* <!-- <img className="injectable hw-24" src=".//assets/media/heroicons/outline/users.svg" alt="Friends icon"> --> */}
                    </Link>
                </li>
                {/* <!-- Friends Tab End --> */}
                ...
                {/* <!-- Profile Tab Start --> */}
                <li className="nav-item">
                    <Link className="nav-link p-0 py-xl-3" id="profile-tab" to="/profile" title="Profile">
                        {/* <!-- Default :: Inline SVG --> */}
                        <svg className="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                        ...
                        {/* <!-- Alternate :: External File link --> */}
                        {/* <!-- <img className="injectable hw-24" src=".//assets/media/heroicons/outline/user-circle.svg" alt="Profile icon"> --> */}
                    </Link>
                </li>
                {/* <!-- Profile Tab End --> */}
            </ul>
